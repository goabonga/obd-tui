...
FIELD_QUANTITY: dict[str, Quantity] = {
    ...
    "egt_bank_1_sensor_1": Quantity.TEMPERATURE,
    "egt_bank_1_sensor_2": Quantity.TEMPERATURE,
    "egt_bank_1_sensor_3": Quantity.TEMPERATURE,
    "egt_bank_1_sensor_4": Quantity.TEMPERATURE,
